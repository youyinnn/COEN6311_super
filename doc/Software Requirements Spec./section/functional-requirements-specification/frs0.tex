\section{Conventions for All API}
 ...
 {\parindent0pt
  ...
  \begin{itemize}
	  ...
	  \item[2] Response json shall contain a property \textquote{code};
	  \item[3] The value of the \textquote{code} shall follow those rules:
		  \begin{itemize}
			  \item Integer type;
  ...
  \begin{itemize}
	  ...
	  \item[2] The token shall be placed in the HTTP headers with key \textquote{Authorization};
